...
Image.create!(photo: File.open('app/assets/images/ron_swanson/meat_1.jpg'),
...
caption:"Keep calm and have a krabby patty", location:"Bikini Bottom", user:spongebob)
...
Following.create!(followee: guest, follower: mikey)
